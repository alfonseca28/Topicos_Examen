 ...
 */
public class InterfazGato extends javax.swing.JFrame {

    String turnoX = "X";
    String turnoO = "O";
    boolean status = true;
    JLabel[] tablero = new JLabel[9];
    ...
    public void colocar(int cuadricula) {
        if (tablero[cuadricula - 1].getText().equals("") && status) {
            tablero[cuadricula - 1].setText(turnoX);
            turnos();
            ganador();
        }
    }
    ...
    private void initComponents() {
        ...
        jpncruceta = new javax.swing.JPanel();
        ...
        javax.swing.GroupLayout jpncrucetaLayout = new javax.swing.GroupLayout(jpncruceta);
        jpncruceta.setLayout(jpncrucetaLayout);
        jpncrucetaLayout.setHorizontalGroup(
            jpncrucetaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jpncrucetaLayout.createSequentialGroup()
                .addGroup(jpncrucetaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jpncrucetaLayout.createSequentialGroup()
        ...
        jpncrucetaLayout.setVerticalGroup(
            jpncrucetaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            .addGroup(jpncrucetaLayout.createSequentialGroup()
                .addGroup(jpncrucetaLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel1, javax.swing.GroupLayout.PREFERRED_SIZE, 96, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(jpncruceta, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 30, 300, 300));
        ...
        jPanel1.add(btnsalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(300, 380, 57, -1));

        jbtnreiniciar.setText("Empezar de nuevo");
        jbtnreiniciar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jbtnreiniciarActionPerformed(evt);
            }
        });
        jPanel1.add(jbtnreiniciar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 380, 160, -1));
    ...
    private javax.swing.JPanel jpncruceta;
