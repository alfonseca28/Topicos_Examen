...
public class InterfazGato extends javax.swing.JFrame {
    ...
    public void colocar(int cuadricula) {
        if (array[cuadricula - 1].getText().equals("") && status) {
            array[cuadricula - 1].setText(turnoX);
            turnos();
            ganador();
        }
    }
    ...
    public void ganador() {
        ...
        for (int i = 0; i < ganadores.length; i++) {
            if (array[ganadores[i][0] - 1].getText().equals("X") && array[ganadores[i][1] - 1].getText().equals("X") && array[ganadores[i][2] - 1].getText().equals("X")) {
                JOptionPane.showMessageDialog(null, "Ganan las X");
                status = false;
            } else if (array[ganadores[i][0] - 1].getText().equals("O") && array[ganadores[i][1] - 1].getText().equals("O") && array[ganadores[i][2] - 1].getText().equals("O")) {
